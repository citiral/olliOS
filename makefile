...
KERNEL_CPP = $(wildcard kernel/*.cpp) $(wildcard kernel/util/*.cpp) $(wildcard kernel/streams/*.cpp) $(wildcard kernel/alloc/*.cpp) $(wildcard kernel/ata/*.cpp) $(wildcard kernel/fs/*.cpp) $(wildcard kernel/kstd/*.cpp)  $(wildcard kernel/memory/*.cpp) $(wildcard kernel/pci/*.cpp)
KERNEL_ASM = $(wildcard kernel/*.s)
HEADERS = $(wildcard kernel/*.h) $(wildcard kernel/util/*.h) $(wildcard kernel/streams/*.h) $(wildcard kernel/alloc/*.h) $(wildcard kernel/ata/*.h) $(wildcard kernel/fs/*.h) $(wildcard kernel/kstd/*.h)  $(wildcard kernel/memory/*.h) $(wildcard kernel/memory/*.h)
